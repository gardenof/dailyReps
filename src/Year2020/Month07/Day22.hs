module Year2020.Month07.Day22 () where
...
anyNameIsLong2 :: Bool
anyNameIsLong2 = all isLongName names
...
{-
shortenName, withRemainder :: String -> String
(shortenName, withRemainder) = splitAt 7
-}
