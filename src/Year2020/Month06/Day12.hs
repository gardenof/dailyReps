module Year2020.Month06.Day12 () where
...
personOne :: Person
personOne = Person(Name"JIM")(HomeTown"Moon4")(Age 22)
...
trivialDollar :: Int
trivialDollar = length $ "something"

parenthesesLength :: Int
parenthesesLength = length("something")
...
dollarsX3 :: Int
dollarsX3 = length $ words $ concat $ ["one and "++"Two"]
