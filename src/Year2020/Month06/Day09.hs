module Year2020.Month06.Day09 () where
...
personOne :: Person
personOne = Person(Name"Kim")(Hometown"TheMoon")(Age 32)
...
trivialDollar :: Int
trivialDollar = length $ "sometimes here"

parenthesesLength :: Int
parenthesesLength = length ("one and " ++ "two")
