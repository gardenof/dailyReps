...
createCarRecord :: String -> Int -> Car
createCarRecord name year =
  Car { carName = name, carYear = year }

carConstructor :: String -> Int -> Car
carConstructor = Car

carConstructorTwo :: String -> Int -> Car
carConstructorTwo name year =
  Car name year

carUpdateName :: String -> Car -> Car
carUpdateName newName car =
  car { carName = newName }
...
personOne :: Person
personOne = Person (Name "jim") (Hometown"moon") (Age 23)
